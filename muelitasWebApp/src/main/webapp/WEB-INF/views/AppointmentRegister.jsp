...
<script>
  ...
  <body class="bg-dark">
      ...
      <div class="card card-register mx-auto mt-5">
        <div class="card-header">Register an Appointment</div>
          ...
          <div class="container">
            <div class="form-group">
              <div class="form-row">
                <div class="col-md-6">
                    ...
                    <input type="text" name="HealthCard" class="form-control" placeholder="Health Card" required="required" autofocus="autofocus">
            ...
            <option value="0830">8:45</option>
             <option value="0845">9:00</option>
              ...
              <select name="lenguajes_programacion" class="form-control">
            ...
            <option value="C03">Power Builder</option>
              ...
              <select name="Doctores" class="form-control">
              <option value="C01">Juan</option>
             <option value="C02">Pedro</option>
            <option value="C03">Jose</option>
            </select>
     ...
     <br>
      ...
      <div class="col-md-6">
            ...
            <a class="btn btn-primary btn-block" href="index.jsp">Register</a>
